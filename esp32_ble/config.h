...
#define ENABLE_UDP true                      // Enable UDP logging, comment to disable
#define UDP_REMOTE_IP   "192.168.178.10"     // Target IP for UDP logging
#define UDP_REMOTE_PORT 4210                 // Target port for UDP logging
...
#define WIFI_STA_SSID   "WTZW2G"      // WiFi SSID      (leave empty ("") to not use WiFi)
#define WIFI_STA_PSK    "23041985"  // WiFi password  (leave empty ("") to not use WiFi)
...
#define MQTT_HOSTNAME   "192.168.178.11"  // IP or hostname (example: "192.168.2.60")
#define MQTT_PORT       1883
#define MQTT_CLIENT_ID  Ardumower
